...
const prefixes = [
    "Sharma", "Verma", "Gupta", "Tata", "Reliance", "Adani", "Birla", "Mahindra", "Bajaj", "Godrej", 
    "Hindustan", "Bharat", "India", "National", "Asian", "Orient", "Ganga", "Yamuna", "Narmada", "Godavari", 
    "Krishna", "Kaveri", "Brahmaputra", "Himalaya", "Vindhya", "Aravali", "Nilgiri", "Deccan", "Malabar", 
    "Coromandel", "Surya", "Chandra", "Akash", "Prithvi", "Agni", "Vayu", "Jal", "Tej", "Shakti", "Gati", 
    "Pragati", "Vikas", "Navya", "Modern", "New Age", "Future", "Apex", "Summit", "Crown", "Royal", "Imperial", 
    "Shree", "Om", "Swastik", "Jai", "Vijay", "Anand", "Shanti", "Prem", "Kiran", "Jyoti", "Uday", "Sunrise", 
    "Horizon", "Shiv", "Balaji", "Tirupati", "Ganesh", "Lakshmi", "Saraswati", "Durga", "Bhavani", "Amba", 
    "Rama", "Vishnu", "Mahesh", "Raj", "Kapoor", "Singh", "Reddy", "Patel", "Shah", "Mehta", "Desai", "Jain", 
    "Agarwal", "Bansal", "Mittal", "Garg", "Goel", "Chauhan", "Rajput", "Rao", "Nair", "Menon", "Iyer", 
    "Iyengar", "Pillai", "Das", "Bose", "Ghosh", "Mukherjee", "Banerjee", "Chatterjee", "Sen", "Nath"
];
...
if (match) {
    ...
    console.log('Injected Indian client list into marquee.');
} else {
